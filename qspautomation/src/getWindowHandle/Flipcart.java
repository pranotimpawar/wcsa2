...
public class Flipcart {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[.='Green']/ancestor::div[@class='_2OTVHf _3NVE7n _1mQK5h _2J-DXM']/preceding-sibling::a")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//a[contains(text(),'256 GB')]"));
		Thread.sleep(2000);
